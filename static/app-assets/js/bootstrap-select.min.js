...
!function (e, t) {
    ...
    !function (O) {
        ...
        function v(e, t) {
            ...
            if (-1 !== O.inArray(i, t)) return -1 === O.inArray(i, r) || Boolean(e.nodeValue.match(l) || e.nodeValue.match(a));
            for (var n = O(t).filter(function (e, t) {
        ...
        var o = {useDefault: !1, _set: O.valHooks.select.set};
        ...
        function $(e, t, i, n) {
            for (var s = ["content", "subtext", "tokens"], o = !1, r = 0; r < s.length; r++) {
                var l = s[r], a = e[l];
                if (a && (a = a.toString(), "content" === l && (a = a.replace(/<[^>]+>/g, "")), n && (a = g(a)), a = a.toUpperCase(), o = "contains" === i ? 0 <= a.indexOf(t) : a.startsWith(t))) break
            }
            return o
        }
        ...
        O.fn.triggerNative = function (e) {
            var t, i = this[0];
            i.dispatchEvent ? (h ? t = new Event(e, {bubbles: !0}) : (t = document.createEvent("Event")).initEvent(e, !0, !1), i.dispatchEvent(t)) : i.fireEvent ? ((t = document.createEventObject()).eventType = e, i.fireEvent("on" + e, t)) : this.trigger(e)
        };
        var p = {
                "\xc0": "A",
                "\xc1": "A",
        ...
        function g(e) {
            return (e = e.toString()) && e.replace(u, m).replace(f, "")
        }
        ...
        var b, w, x, I, k, U = (b = {
            ...
            return b[e]
        }, x = "(?:" + Object.keys(b).join("|") + ")", I = RegExp(x), k = RegExp(x, "g"), function (e) {
            return e = null == e ? "" : "" + e, I.test(e) ? e.replace(k, w) : e
        }), y = {
            32: " ",
            48: "0",
            49: "1",
            ...
            104: "8",
            105: "9"
        }, C = 27, z = 13, L = 32, A = 9, H = 38, D = 40, N = {success: !1, major: "3"};
        try {
            N.full = (O.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split("."), N.major = N.full[0], N.success = !0
        } catch (e) {
        ...
        "4" === N.major && (V.DIVIDER = "dropdown-divider", V.SHOW = "show", V.BUTTONCLASS = "btn-light", V.POPOVERHEADER = "popover-header");
        var j = {
        ...
        j.a.setAttribute("role", "option"), j.subtext.className = "text-muted", j.text = j.span.cloneNode(!1), j.text.className = "text";
        var M = new RegExp(H + "|" + D), F = new RegExp("^" + A + "$|" + C), _ = function (e, t, i) {
            ...
            return e && (11 === e.nodeType ? n.appendChild(e) : n.insertAdjacentHTML("beforeend", e)), void 0 !== t && "" !== t && (n.className = t), "4" === N.major && n.classList.add("dropdown-item"), i && n.setAttribute("style", i), n
        }, q = function (e, t) {
            ...
            if (e.optionContent) s.innerHTML = e.optionContent; else {
                if (s.textContent = e.text, e.optionIcon) {
                    ...
                    (n = (!0 === t ? j.i : j.span).cloneNode(!1)).className = e.iconBase + " " + e.optionIcon, j.fragment.appendChild(n), j.fragment.appendChild(o)
                }
                e.optionSubtext && ((i = j.subtext.cloneNode(!1)).textContent = e.optionSubtext, s.appendChild(i))
            }
            if (!0 === t) for (; 0 < s.childNodes.length;) j.fragment.appendChild(s.childNodes[0]); else j.fragment.appendChild(s);
            return j.fragment
        }, K = function (e) {
            var t, i, n = j.text.cloneNode(!1);
            if (n.innerHTML = e.labelEscaped, e.labelIcon) {
                var s = j.whitespace.cloneNode(!1);
                (i = j.span.cloneNode(!1)).className = e.iconBase + " " + e.labelIcon, j.fragment.appendChild(i), j.fragment.appendChild(s)
            }
            return e.labelSubtext && ((t = j.subtext.cloneNode(!1)).textContent = e.labelSubtext, n.appendChild(t)), j.fragment.appendChild(n), j.fragment
        }, Y = function (e, t) {
            var i = this;
        ...
        function Z(e) {
            ...
            if ([].shift.apply(a), !N.success) {
                try {
                    N.full = (O.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split(".")
                } catch (e) {
                    N.full = Y.BootstrapVersion.split(" ")[0].split(".")
                }
                N.major = N.full[0], N.success = !0, "4" === N.major && (V.DIVIDER = "dropdown-divider", V.SHOW = "show", V.BUTTONCLASS = "btn-light", Y.DEFAULTS.style = V.BUTTONCLASS = "btn-light", V.POPOVERHEADER = "popover-header")
            }
            var t = this.each(function () {
                ...
                if (e.is("select")) {
                    ...
                    if (t) {
                        ...
                        var s = e.data();
                        for (var o in s) s.hasOwnProperty(o) && -1 !== O.inArray(o, d) && delete s[o];
                        var r = O.extend({}, Y.DEFAULTS, O.fn.selectpicker.defaults || {}, s, i);
                        r.template = O.extend({}, Y.DEFAULTS.template, O.fn.selectpicker.defaults ? O.fn.selectpicker.defaults.template : {}, s.template, i.template), e.data("selectpicker", t = new Y(this, r))
                    }
        ...
        Y.VERSION = "1.13.6", Y.BootstrapVersion = N.major, Y.DEFAULTS = {
            ...
            sanitizeFn: null,
            whiteList: e
        }, "4" === N.major && (Y.DEFAULTS.style = "btn-light", Y.DEFAULTS.iconBase = "", Y.DEFAULTS.tickIcon = "bs-ok-default"), Y.prototype = {
            constructor: Y, init: function () {
                var i = this, e = this.$element.attr("id");
                this.selectId = R++, this.$element[0].classList.add("bs-select-hidden"), this.multiple = this.$element.prop("multiple"), this.autofocus = this.$element.prop("autofocus"), this.$newElement = this.createDropdown(), this.$element.after(this.$newElement).prependTo(this.$newElement), this.$button = this.$newElement.children("button"), this.$menu = this.$newElement.children(B.MENU), this.$menuInner = this.$menu.children(".inner"), this.$searchbox = this.$menu.find("input"), this.$element[0].classList.remove("bs-select-hidden"), !0 === this.options.dropdownAlignRight && this.$menu[0].classList.add(V.MENURIGHT), void 0 !== e && this.$button.attr("data-id", e), this.checkDisabled(), this.clickListener(), this.options.liveSearch && this.liveSearchListener(), this.render(), this.setStyle(), this.setWidth(), this.options.container ? this.selectPosition() : this.$element.on("hide" + W, function () {
                    if (i.isVirtual()) {
                ...
                e = e || 0;
                var A = this;
                this.selectpicker.current = L ? this.selectpicker.search : this.selectpicker.main;
                var H, D, N = [];
                ...
                function i(e, t) {
                    ...
                    if (void 0 === r && (r = 0), l = [A.selectpicker.view.position0, A.selectpicker.view.position1], s = Math.max(0, r - 1), o = Math.min(n - 1, r + 1), A.selectpicker.view.position0 = Math.max(0, u[s][0]) || 0, A.selectpicker.view.position1 = Math.min(p, u[o][1]) || 0, a = l[0] !== A.selectpicker.view.position0 || l[1] !== A.selectpicker.view.position1, void 0 !== A.activeIndex && (D = A.selectpicker.current.elements[A.selectpicker.current.map.newIndex[A.prevActiveIndex]], N = A.selectpicker.current.elements[A.selectpicker.current.map.newIndex[A.activeIndex]], H = A.selectpicker.current.elements[A.selectpicker.current.map.newIndex[A.selectedIndex]], t && (A.activeIndex !== A.selectedIndex && N && N.length && (N.classList.remove("active"), N.firstChild && N.firstChild.classList.remove("active")), A.activeIndex = void 0), A.activeIndex && A.activeIndex !== A.selectedIndex && H && H.length && (H.classList.remove("active"), H.firstChild && H.firstChild.classList.remove("active"))), void 0 !== A.prevActiveIndex && A.prevActiveIndex !== A.activeIndex && A.prevActiveIndex !== A.selectedIndex && D && D.length && (D.classList.remove("active"), D.firstChild && D.firstChild.classList.remove("active")), (t || a) && (c = A.selectpicker.view.visibleElements ? A.selectpicker.view.visibleElements.slice() : [], A.selectpicker.view.visibleElements = A.selectpicker.current.elements.slice(A.selectpicker.view.position0, A.selectpicker.view.position1), A.setOptionStatus(), (L || !1 === m && t) && (d = c, h = A.selectpicker.view.visibleElements, f = !(d.length === h.length && d.every(function (e, t) {
                        ...
                        for (var S = $.length; v < S; v++) {
                            var E, C, z = $[v];
                            A.options.sanitize && (E = z.lastChild) && (C = A.selectpicker.current.data[v + A.selectpicker.view.position0].data) && C.content && !C.sanitized && (y.push(E), C.sanitized = !0), I.appendChild(z)
                        }
                    ...
                    if (A.prevActiveIndex = A.activeIndex, A.options.liveSearch) {
                        if (L && t) {
                            var O, T = 0;
                            A.selectpicker.view.canHighlight[T] || (T = 1 + A.selectpicker.view.canHighlight.slice(1).indexOf(!0)), O = A.selectpicker.view.visibleElements[T], A.selectpicker.view.currentActive && (A.selectpicker.view.currentActive.classList.remove("active"), A.selectpicker.view.currentActive.firstChild && A.selectpicker.view.currentActive.firstChild.classList.remove("active")), O && (O.classList.add("active"), O.firstChild && O.firstChild.classList.add("active")), A.activeIndex = A.selectpicker.current.map.originalIndex[T]
                        }
                ...
                }), O(window).off("resize" + W + "." + this.selectId + ".createView").on("resize" + W + "." + this.selectId + ".createView", function () {
                    A.$newElement.hasClass(V.SHOW) && i(A.$menuInner[0].scrollTop)
                })
                ...
                if (this.options.title && !this.multiple) {
                    ...
                    if (n) this.selectpicker.view.titleOption.className = "bs-title-option", this.selectpicker.view.titleOption.value = "", i = void 0 === O(t.options[t.selectedIndex]).attr("selected") && void 0 === this.$element.data("selected");
                ...
                var e, t, i = this, n = i.options.iconBase, s = ':not([hidden]):not([data-hidden="true"])', o = [],
                    r = 0, l = [], a = 0, c = 0, d = -1;
                this.options.hideDisabled && (s += ":not(:disabled)"), (i.options.showTick || i.multiple) && ((e = j.span.cloneNode(!1)).className = n + " " + i.options.tickIcon + " check-mark", j.a.appendChild(e)), this.setPlaceholder() && d--;
                for (var h = this.$element[0].options, p = 0, u = h.length; p < u; p++) {
                    ...
                    if (d++, !f.classList.contains("bs-title-option")) {
                        var m, v, g, b, w = {
                            ...
                            z = "OPTGROUP" === S.tagName, O = z && S.disabled, T = f.disabled || O,
                            L = C && "OPTGROUP" === C.tagName, A = {hidden: "true" === S.getAttribute("data-hidden")};
                        if (!0 === w.hidden || f.hidden || z && (!0 === A.hidden || S.hidden) || i.options.hideDisabled && (T || O)) m = f.prevHiddenIndex, E && (E.prevHiddenIndex = void 0 !== m ? m : p), d--; else {
                            if (E && void 0 !== E.prevHiddenIndex && (E.prevHiddenIndex = void 0), z && !0 !== w.divider) {
                                ...
                                if (void 0 !== (m = f.prevHiddenIndex) && (D = h[m].previousElementSibling), !D) {
                                    ...
                                    0 !== p && 0 < o.length && (d++, o.push(_(!1, V.DIVIDER, a + "div")), l.push({
                                        type: "divider",
                                        optID: a
                                    })), d++, g = K({
                                        labelEscaped: P,
                                        ...
                                        labelIcon: W,
                                        iconBase: n
                                    }), o.push(_(g, "dropdown-header" + H, a)), l.push({
                                        content: P,
                                        subtext: R,
                                        type: "optgroup-label",
                                        optID: a
                                ...
                                v = q({
                                    ...
                                    optionIcon: w.icon,
                                    iconBase: n
                                }), o.push(_(G(v, "opt " + x + H, k), "", a)), l.push({
                                    content: $ || y,
                                    subtext: w.subtext,
                                    tokens: w.tokens,
                                    type: "option",
                            ...
                            } else if (!0 === w.divider) o.push(_(!1, V.DIVIDER)), l.push({
                                type: "divider",
                                originalIndex: p,
                                data: w
                            }); else {
                                if (i.options.hideDisabled) if (L) C.querySelectorAll("option:disabled").length === C.children.length && (L = !1); else if (void 0 !== (m = f.prevHiddenIndex)) if ((b = h[m].previousElementSibling) && "OPTGROUP" === b.tagName && !b.disabled) b.querySelectorAll("option:disabled").length < b.children.length && (L = !0);
                                L && l.length && "divider" !== l[l.length - 1].type && (d++, o.push(_(!1, V.DIVIDER, a + "div")), l.push({
                                    type: "divider",
                                    optID: a
                                })), v = q({
                                    text: y,
                ...
                this.setPlaceholder();
                var e, t, i = this, n = this.$element[0].selectedOptions, s = n.length,
                    o = this.$button.find(".filter-option-inner-inner")[0],
                    r = document.createTextNode(this.options.multipleSeparator), l = j.fragment.cloneNode(!1), a = !1;
                if (this.togglePlaceholder(), this.tabIndex(), "static" === this.options.selectedTextFormat) l = q({text: this.options.title}, !0); else if ((e = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && 1 < s) && (e = 1 < (t = this.options.selectedTextFormat.split(">")).length && s > t[1] || 1 === t.length && 2 <= s), !1 === e) {
                    for (var c = 0; c < s && c < 50; c++) {
                        ...
                        this.multiple && 0 < c && l.appendChild(r.cloneNode(!1)), d.title ? h.text = d.title : p.content && i.options.showContent ? (h.optionContent = p.content.toString(), a = !0) : (i.options.showIcon && (h.optionIcon = p.icon, h.iconBase = this.options.iconBase), i.options.showSubtext && !i.multiple && p.subtext && (h.optionSubtext = " " + p.subtext), h.text = d.textContent.trim()), l.appendChild(q(h, !0))
                    }
                    49 < s && l.appendChild(document.createTextNode("..."))
                } else {
                    var u = ':not([hidden]):not([data-hidden="true"]):not([data-divider="true"])';
                    this.options.hideDisabled && (u += ":not(:disabled)");
                    var f = this.$element[0].querySelectorAll("select > option" + u + ", optgroup" + u + " option" + u).length,
                        m = "function" == typeof this.options.countSelectedText ? this.options.countSelectedText(s, f) : this.options.countSelectedText;
                    l = q({text: m.replace("{0}", s.toString()).replace("{1}", f.toString())}, !0)
                }
                null == this.options.title && (this.options.title = this.$element.attr("title")), l.childNodes.length || (l = q({text: void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText}, !0)), this.$button[0].title = l.textContent.replace(/<[^>]*>?/g, "").trim(), this.options.sanitize && a && P([l], i.options.whiteList, i.options.sanitizeFn), o.innerHTML = "", o.appendChild(l), this.$element.trigger("rendered" + W)
            }, setStyle: function (e, t) {
                var i = this.$button[0];
                this.$element.attr("class") && this.$newElement.addClass(this.$element.attr("class").replace(/selectpicker|mobile-device|bs-select-hidden|validate\[.*\]/gi, ""));
                var n = e || this.options.style;
                "add" == t ? i.classList.add(n) : "remove" == t ? i.classList.remove(n) : (i.classList.remove(this.options.style), i.classList.add(n))
            }, liHeight: function (e) {
                if (e || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var v, g = a.offsetHeight, b = r ? r.offsetHeight : 0, w = d ? d.offsetHeight : 0,
                        ...
                        $ = O(o).outerHeight(!0), y = !!window.getComputedStyle && window.getComputedStyle(i),
                        S = i.offsetWidth, E = y ? null : O(i), C = {
                            vert: T(y ? y.paddingTop : E.css("paddingTop")) + T(y ? y.paddingBottom : E.css("paddingBottom")) + T(y ? y.borderTopWidth : E.css("borderTopWidth")) + T(y ? y.borderBottomWidth : E.css("borderBottomWidth")),
                            horiz: T(y ? y.paddingLeft : E.css("paddingLeft")) + T(y ? y.paddingRight : E.css("paddingRight")) + T(y ? y.borderLeftWidth : E.css("borderLeftWidth")) + T(y ? y.borderRightWidth : E.css("borderRightWidth"))
                        }, z = {
                            vert: C.vert + T(y ? y.marginTop : E.css("marginTop")) + T(y ? y.marginBottom : E.css("marginBottom")) + 2,
                            horiz: C.horiz + T(y ? y.marginLeft : E.css("marginLeft")) + T(y ? y.marginRight : E.css("marginRight")) + 2
                        };
                ...
                var e, t = O(window), i = this.$newElement.offset(), n = O(this.options.container);
                ...
                "auto" === this.options.dropdownAlignRight && this.$menu.toggleClass(V.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.sizeInfo.totalMenuWidth - a), this.$menu.css({
                    "max-height": o + "px",
                    overflow: "hidden",
                    "min-height": n + "px"
                }), this.$menuInner.css({
                ...
                var n, s, o, r = this, l = O(this.options.container), e = function (e) {
                    var t = {},
                        i = r.options.display || !!O.fn.dropdown.Constructor.Default && O.fn.dropdown.Constructor.Default.display;
                    r.$bsContainer.addClass(e.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(V.DROPUP, e.hasClass(V.DROPUP)), n = e.offset(), l.is("body") ? s = {
                        top: 0,
                        left: 0
                    } : ((s = l.offset()).top += parseInt(l.css("borderTopWidth")) - l.scrollTop(), s.left += parseInt(l.css("borderLeftWidth")) - l.scrollLeft()), o = e.hasClass(V.DROPUP) ? 0 : e[0].offsetHeight, (N.major < 4 || "static" === i) && (t.top = n.top - s.top + o, t.left = n.left - s.left), t.width = e[0].offsetWidth, r.$bsContainer.css(t)
                };
                ...
                }), O(window).off("resize" + W + "." + this.selectId + " scroll" + W + "." + this.selectId).on("resize" + W + "." + this.selectId + " scroll" + W + "." + this.selectId, function () {
                ...
                var s;
                i || (i = this.selectpicker.main.map.newIndex[e]), n || (n = this.selectpicker.main.elements[i]), s = n.firstChild, n.classList.toggle(V.DISABLED, t), s && ("4" === N.major && s.classList.toggle(V.DISABLED, t), s.setAttribute("aria-disabled", t), t ? s.setAttribute("tabindex", -1) : s.setAttribute("tabindex", 0))
            }, isDisabled: function () {
                ...
                t.data("spaceSelect", !1), this.$button.on("keyup", function (e) {
                    ...
                    3 < N.major && !y.dropdown && (y.dropdown = y.$button.data("bs.dropdown"), y.dropdown._menu = y.$menu[0])
                }), this.$button.on("click.bs.dropdown.data-api", function () {
                    y.$newElement.hasClass(V.SHOW) || y.setSize()
                }), this.$element.on("shown" + W, function () {
                    y.$menuInner[0].scrollTop !== y.selectpicker.view.scrollTop && (y.$menuInner[0].scrollTop = y.selectpicker.view.scrollTop), 3 < N.major ? requestAnimationFrame(i) : e()
                }), this.$menuInner.on("click", "li a", function (e, t) {
                    var i = O(this), n = y.isVirtual() ? y.selectpicker.view.position0 : 0,
                        s = y.selectpicker.current.map.originalIndex[i.parent().index() + n], o = S(y.$element[0]),
                        r = y.$element.prop("selectedIndex"), l = !0;
                    if (y.multiple && 1 !== y.options.maxOptions && e.stopPropagation(), e.preventDefault(), !y.isDisabled() && !i.parent().hasClass(V.DISABLED)) {
                            ...
                            if (c.prop("selected", !d), y.setSelected(s, !d), i.trigger("blur"), !1 !== u || !1 !== f) {
                                ...
                                if (u && m || f && v) if (u && 1 == u) {
                                    ...
                                    var w = "string" == typeof y.options.maxOptionsText ? [y.options.maxOptionsText, y.options.maxOptionsText] : y.options.maxOptionsText,
                                        ...
                                        k = x[1].replace("{n}", f), $ = O('<div class="notify"></div>');
                                    x[2] && (I = I.replace("{var}", x[2][1 < u ? 0 : 1]), k = k.replace("{var}", x[2][1 < f ? 0 : 1])), c.prop("selected", !1), y.$menu.append($), u && m && ($.append(O("<div>" + I + "</div>")), l = !1, y.$element.trigger("maxReached" + W)), f && v && ($.append(O("<div>" + k + "</div>")), l = !1, y.$element.trigger("maxReachedGrp" + W)), setTimeout(function () {
                                        y.setSelected(s, !1)
                    ...
                    e.currentTarget == this && (e.preventDefault(), e.stopPropagation(), y.options.liveSearch && !O(e.target).hasClass("close") ? y.$searchbox.trigger("focus") : y.$button.trigger("focus"))
                    ...
                    y.options.liveSearch ? y.$searchbox.trigger("focus") : y.$button.trigger("focus"), e.preventDefault(), e.stopPropagation(), O(this).hasClass("bs-select-all") ? y.selectAll() : y.deselectAll()
                }), this.$element.on({
                    change: function () {
                        y.render(), y.$element.trigger("changed" + W, E), E = null
                    }, focus: function () {
                ...
                this.$button.on("click.bs.dropdown.data-api", function () {
                    ...
                    if (u.selectpicker.search.map.newIndex = {}, u.selectpicker.search.map.originalIndex = {}, u.selectpicker.search.elements = [], u.selectpicker.search.data = [], e) {
                        ...
                        r && (i = g(i)), u._$lisSelected = u.$menuInner.find(".selected");
                ...
                var t, i, n, s, o, r = O(this), l = r.hasClass("dropdown-toggle"),
                    a = (l ? r.closest(".dropdown") : r.closest(B.MENU)).data("this"), c = a.findLis(), d = !1,
                    h = e.which === A && !l && !a.options.selectOnTab, p = M.test(e.which) || h,
                ...
                if (!(i = a.$newElement.hasClass(V.SHOW)) && (p || 48 <= e.which && e.which <= 57 || 96 <= e.which && e.which <= 105 || 65 <= e.which && e.which <= 90) && (a.$button.trigger("click.bs.dropdown.data-api"), a.options.liveSearch)) a.$searchbox.trigger("focus"); else {
                    if (e.which === C && i && (e.preventDefault(), a.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), p) {
                        if (!c.length) return;
                        ...
                        var v = m + t;
                        e.which === H ? 0 === m && t === c.length - 1 ? (a.$menuInner[0].scrollTop = a.$menuInner[0].scrollHeight, v = a.selectpicker.current.elements.length - 1) : d = (o = (s = a.selectpicker.current.data[v]).position - s.height) < u : (e.which === D || h) && (0 === t ? v = a.$menuInner[0].scrollTop = 0 : d = u < (o = (s = a.selectpicker.current.data[v]).position - a.sizeInfo.menuInnerHeight)), (n = a.selectpicker.current.elements[v]) && (n.classList.add("active"), n.firstChild && n.firstChild.classList.add("active")), a.activeIndex = a.selectpicker.current.map.originalIndex[v], a.selectpicker.view.currentActive = n, d && (a.$menuInner[0].scrollTop = o), a.options.liveSearch ? a.$searchbox.trigger("focus") : r.trigger("focus")
                    } else if (!r.is("input") && !F.test(e.which) || e.which === L && a.selectpicker.keydown.keyHistory) {
                        var g, b, w = [];
                        ...
                        if (w.length) {
                            var k = 0;
                            c.removeClass("active").find("a").removeClass("active"), 1 === b.length && (-1 === (k = w.indexOf(a.activeIndex)) || k === w.length - 1 ? k = 0 : k++), g = a.selectpicker.current.map.newIndex[w[k]], d = 0 < u - (s = a.selectpicker.current.data[g]).position ? (o = s.position - s.height, !0) : (o = s.position - a.sizeInfo.menuInnerHeight, s.position > u + a.sizeInfo.menuInnerHeight), (n = a.selectpicker.current.elements[g]).classList.add("active"), n.firstChild && n.firstChild.classList.add("active"), a.activeIndex = w[k], n.firstChild.trigger("focus"), d && (a.$menuInner[0].scrollTop = o), r.trigger("focus")
                        }
                    }
                    i && (e.which === L && !a.selectpicker.keydown.keyHistory || e.which === z || e.which === A && a.options.selectOnTab) && (e.which !== L && e.preventDefault(), a.options.liveSearch && e.which === L || (a.$menuInner.find(".active a").trigger("click", !0), r.trigger("focus"), a.options.liveSearch || (e.preventDefault(), O(document).data("spaceSelect", !0))))
                }
            }, mobile: function () {
                this.$element[0].classList.add("mobile-device")
            }, refresh: function () {
                var e = O.extend({}, this.options, this.$element.data());
                this.options = e, this.selectpicker.main.map.newIndex = {}, this.selectpicker.main.map.originalIndex = {}, this.checkDisabled(), this.render(), this.createLi(), this.setStyle(), this.setWidth(), this.setSize(!0), this.$element.trigger("refreshed" + W)
            }, hide: function () {
                ...
                this.$newElement.before(this.$element).remove(), this.$bsContainer ? this.$bsContainer.remove() : this.$menu.remove(), this.$element.off(W).removeData("selectpicker").removeClass("bs-select-hidden selectpicker"), O(window).off(W + "." + this.selectId)
            }
        };
        var J = O.fn.selectpicker;
        O.fn.selectpicker = Z, O.fn.selectpicker.Constructor = Y, O.fn.selectpicker.noConflict = function () {
            return O.fn.selectpicker = J, this
        }, O(document).off("keydown.bs.dropdown.data-api").on("keydown" + W, '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', Y.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', function (e) {
            e.stopPropagation()
        }), O(window).on("load" + W + ".data-api", function () {
